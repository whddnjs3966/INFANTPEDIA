    ...
    <div className="mx-4 mb-4 space-y-3">
      ...
      >
        ...
        <motion.div
          ...
          className="mt-3 rounded-2xl bg-teal-50 dark:bg-teal-950/30 dark:p-3"
        >
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        isErupted &&
                          "bg-teal-400 dark:bg-teal-500 dark:text-white",
                        isUpcoming &&
                    ...
                    <div
                      className={cn(
                        "flex-1 rounded-2xl p-2.5 transition-all",
                        isUpcoming &&
                          "bg-cyan-50/80 dark:bg-cyan-950/30 dark:shadow-cyan-100/50 dark:shadow-cyan-900/50",
                        isErupted &&
            ...
            <div className="flex flex-wrap gap-1.5">
              {guide.teethingSymptoms.map((symptom, idx) => (
                <motion.span
                  ...
                  className="inline-flex items-center gap-1 rounded-full bg-amber-50 dark:bg-amber-950/30 dark:px-2.5 py-1.5 text-[11px] font-medium text-amber-700 dark:text-amber-300"
                >
            ...
            <div className="space-y-2">
              {guide.teethingRemedies.map((remedy, idx) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: idx * 0.05 }}
                  className="rounded-2xl dark:bg-teal-50/50 dark:bg-teal-950/20 p-3"
                >
      ...
      >
        ...
        >
          ...
          {/* Fluoride note */}
          <div className="rounded-2xl bg-cyan-50 dark:bg-cyan-950/20 dark:p-3 mb-4">
          ...
          <div className="space-y-2.5">
            {guide.brushingGuide.steps.map((step, idx) => (
              ...
              >
                <div className="w-7 h-7 rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 dark:from-teal-500 dark:to-cyan-600 flex items-center justify-center text-white text-[11px] font-bold shrink-0 ">
                  {step.step}
                </div>
                <div className="flex-1">
