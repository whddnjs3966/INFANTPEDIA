      ...
      <div className="px-4 pt-6 pb-6">
        {loading ? (
          ...
          >
            ...
            <motion.div
              variants={child}
              className="relative overflow-hidden rounded-2xl bg-[#7C5CFC] text-white shadow-[0_4px_16px_rgb(0,0,0,0.08)]"
            >
              ...
              <div className="relative z-10 p-5">
                ...
                <div className="flex items-center gap-4 mb-5">
                  ...
                  >
                    <div className="relative h-[72px] w-[72px] rounded-full bg-white/15 backdrop-blur-sm overflow-hidden ring-2 ring-white/25 shadow-lg">
                      {photoUrl ? (
                    ...
                    <div className="absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-white shadow-md">
                      <Camera size={11} className="text-[#7C5CFC]" />
                    </div>
                  </button>
                  <input ref={fileInputRef} type="file" accept="image/*" className="hidden" onChange={handlePhotoSelect} />

                  <div className="flex-1 min-w-0">
                    <p className="text-[12px] font-medium text-white/60">{greeting}</p>
                    <h1 className="text-[20px] font-extrabold tracking-tight leading-tight truncate">
                      {profile.name} 부모님
                    </h1>
                    <div className="mt-1.5 flex items-center gap-1.5">
                      <span className="inline-flex items-center gap-1 rounded-full bg-white/15 px-2 py-0.5 text-[11px] font-semibold text-white/85">
                        <Calendar size={11} />
                ...
                <div className="rounded-2xl bg-white/10 backdrop-blur-sm p-4">
                  <div className="flex items-center justify-between mb-2.5">
                    ...
                    <div className="text-right">
                      <p className="text-[11px] text-white/40 font-medium">{months}개월 진행률</p>
            ...
            {isOver12 && (
              <motion.div
                variants={child}
                className="rounded-2xl border border-purple-200/40 bg-white p-4 shadow-[0_2px_8px_rgb(0,0,0,0.06)] dark:border-purple-800/30 dark:bg-stone-900"
              >
            ...
            {error ? (
              <motion.div
                variants={child}
                className="rounded-2xl bg-stone-100 p-6 text-center dark:bg-stone-800/50"
              >
              ...
              <>
                ...
                <motion.div variants={child} className="grid grid-cols-3 gap-2.5">
                  ...
                  >
                    ...
                    <p className="text-[11px] text-stone-400 dark:text-stone-500 mt-0.5">ml/일 수유량</p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-[11px] text-stone-400 dark:text-stone-500 mt-0.5">시간 수면</p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-[11px] text-stone-400 dark:text-stone-500 mt-0.5">접종 완료</p>
                  </div>
                </motion.div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.97 }}
                    onClick={() => router.push("/encyclopedia")}
                    className="cursor-pointer rounded-2xl border border-stone-200 bg-white p-4 shadow-[0_2px_8px_rgb(0,0,0,0.06)] dark:border-stone-700 dark:bg-stone-900"
                  >
                ...
                {months >= 4 && (
                  <motion.div
                    variants={child}
                    className="rounded-2xl border border-stone-200 bg-white p-4 shadow-[0_2px_8px_rgb(0,0,0,0.06)] dark:border-stone-700 dark:bg-stone-900"
                  >
                ...
                <motion.button
                  ...
                  className="w-full rounded-2xl border border-stone-200 bg-white p-4 text-left shadow-[0_2px_8px_rgb(0,0,0,0.06)] dark:border-stone-700 dark:bg-stone-900"
                >
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="rounded-full bg-amber-500 px-1.5 py-0.5 text-[11px] font-bold text-white leading-none">
                ...
                <motion.div
                  variants={child}
                  className="rounded-2xl border border-stone-200 bg-white p-5 shadow-[0_2px_8px_rgb(0,0,0,0.06)] dark:border-stone-700 dark:bg-stone-900"
                >
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/60 p-3.5">
                      <p className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 mb-1">대근육 발달</p>
                    ...
                    <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/60 p-3.5">
                      <p className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 mb-1">언어 발달</p>
                      <p className="text-[13px] font-bold text-gray-800 dark:text-gray-100">
                        {months <= 1 ? "울음으로 소통" : months <= 3 ? "옹알이 시작" : months <= 5 ? "소리에 반응" : months <= 7 ? "모음 소리 내기" : months <= 9 ? "자음 옹알이" : months <= 11 ? "맘마·빠빠" : "단어 1~3개"}
                      </p>
                    </div>
                    <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/60 p-3.5">
                      <p className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 mb-1">소근육 발달</p>
                      <p className="text-[13px] font-bold text-gray-800 dark:text-gray-100">
                        {months <= 1 ? "반사적 움켜쥠" : months <= 3 ? "손 펴기" : months <= 5 ? "물건 잡기" : months <= 7 ? "양손 옮기기" : months <= 9 ? "엄지로 집기" : months <= 11 ? "집게손 사용" : "블록 쌓기"}
                      </p>
                    </div>
                    <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/60 p-3.5">
                      <p className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 mb-1">사회성 발달</p>
                      <p className="text-[13px] font-bold text-gray-800 dark:text-gray-100">
